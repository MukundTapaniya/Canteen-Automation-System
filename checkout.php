...
if (empty($_SESSION["user_id"])) {
    ...
    <head>
        ...
        <link rel="icon" href="#">
        <title>checkout || Canteen Automation System</title>
                                        ...
                                        <div class="col-sm-12">
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        <label class="custom-control custom-radio m-b-10">
                                                            ...
                                                            <span class="custom-control-indicator"></span>
                                                            <span class="custom-control-description">Paypal <img
                                                                    src="images/paypal.jpg" alt="" width="90"></span>
                                                        </label>
                                                    </li>
                                                </ul>
                                                <p class="text-xs-center">
                                                    <input type="submit" onclick="return orderConfirm();" name="submit"
                                            ...
                                            <script>
                                                function orderConfirm() {
                                                    if (document.querySelector('input[name="mod"]:checked').value === "paypal") {
